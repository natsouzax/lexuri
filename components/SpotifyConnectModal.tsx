    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: '0.72rem', color: 'var(--muted)', marginBottom: 20, lineHeight: 1.5 }}>
          We only request read access to your top tracks and listening history. We never control playback or modify your account.
        </p>
