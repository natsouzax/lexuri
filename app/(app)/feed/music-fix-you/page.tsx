...
import staticData from '@/data/featured-lessons/music-fix-you'
import { getFeedItem } from '@/lib/feed'
import type { LessonData } from '@/components/LessonView'

const item = getFeedItem('music-fix-you')
...
export default function Page() {
  return <LessonView feedItemId="music-fix-you" initialLesson={initialLesson} />
}
