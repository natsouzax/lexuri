...
import staticData from '@/data/featured-lessons/music-happy'
import { getFeedItem } from '@/lib/feed'
import type { LessonData } from '@/components/LessonView'

const item = getFeedItem('music-happy')
...
export default function Page() {
  return <LessonView feedItemId="music-happy" initialLesson={initialLesson} />
}
