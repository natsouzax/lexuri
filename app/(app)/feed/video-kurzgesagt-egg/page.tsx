...
import staticData from '@/data/featured-lessons/video-kurzgesagt-egg'
import { getFeedItem } from '@/lib/feed'
import type { LessonData } from '@/components/LessonView'

const item = getFeedItem('video-kurzgesagt-egg')
...
export default function Page() {
  return <LessonView feedItemId="video-kurzgesagt-egg" initialLesson={initialLesson} />
}
